...
public class Chef extends Employe{
    ...
    public void afficher() {
        System.out.println("le nom: "+nom+" le prenom:  "+prenom+" l'adresse: "+adresse+" la ville est "+ville+" date naissance: "+dateNaissance+" et le salaire "+salaire+" service"+service);
